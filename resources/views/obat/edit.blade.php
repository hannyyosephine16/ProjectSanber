        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container">
                    ...
                    <a href="{{ route('obat.index') }}" class="btn btn-primary mb-3">Data Obat</a>
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('obat.update', $obat->id) }}" method="POST">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="nama" id="nama" value={{ $obat->nama }}>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="sediaan" class="col-sm-2 col-form-label ml-5">Sediaan</label>
                                    <div class="col-sm-2">
                                        <select class="form-select form-control" name="sediaan" id="sediaan" value={{ $obat->sediaan }}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-select form-control" name="golongan" id="golongan" value={{ $obat->golongan }}>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="harga" id="harga" placeholder="Rp." value={{ $obat->harga }}>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label for="jumlah" class="col-sm-2 col-form-label ml-5">Stok Obat</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="jumlah" id="jumlah" value={{ $obat->jumlah }}>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary float-right mr-5">Edit</button>
                            </form>
                        </div>
                    </div>
                </div>
